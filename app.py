...
    
    # Se for admin testando, ele pode escolher qual padrinho quer "simular"
    if st.session_state.perfil == "admin":
...
            fig = go.Figure(go.Scatter(x=CATEGORIAS, y=[float(row[c]) for c in CATEGORIAS], mode='lines+markers+text', textposition="top center", fill='tozeroy', line=dict(color=C_AZUL, width=4, shape='spline')))
